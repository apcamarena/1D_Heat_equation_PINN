...
The project structure was inspired by PINN examples shared with me by my advisor, but all code and analysis were written by **Anabel Camarena**.
...
- The learned diffusivity satisfied:
  $$\alpha_{learned} \approx \alpha_{true} \quad with error <1%$$
...
- Compared to a baseline neural network trained only on data:
  ...
  - the baseline produced unstable, noisy estimates of $\hat{\alpha}(x,t)$
...
This work was completed as part of my graduate research in Applied Mathematics at UC Irvine under the guidance of Dr. John Lowengrub. The overall project structure was inspired by example PINN implementations previously shared with me by my advisor. All code and model development in this repository are my own original work.
